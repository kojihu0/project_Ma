...
public class CampaignDAO extends ConnectionDB{
	...
	public List<CampaignVO> campaignAllRecord(PagingVO pageVO){
		...
		try {
			...
			if(pageVO.getPageNum()==pageVO.getTotalPage()) {//마지막페이지 일떄
			...
			System.out.println("캠페인 리스트 선택 에러...."+e.getMessage());
		}finally {
			closeDB();
		}
		return list;
	...
	public List<CampaignVO> exCampaigns(PagingVO pageVO){
		...
		try {
			...
			System.out.println("오픈예정 캠페인 리스트 선택 에러....");
		}finally {
			closeDB();
		}
		return list;
	...
	public List<CampaignVO> preCampaigns(PagingVO pageVO){
		...
		try {
			...
			System.out.println("지난 캠페인 리스트 선택 에러....");
		}finally {
			closeDB();
		}
		return list;
	...
	public int getTotalRecord(PagingVO pageVO) {
		...
		try {
			...
			System.out.println("총레코드 수 구하기 에러...."+e.getMessage());
		}finally {
			closeDB();
		}
		return totalRecord;
	...
	public int getPreTotalRecord(PagingVO pageVO) {
		...
		try {
			...
			System.out.println("지난 캠페인 총레코드 수 구하기 에러...."+e.getMessage());
		}finally {
			closeDB();
		}
	...
	public int getExTotalRecord(PagingVO pageVO) {
		...
		try {
			...
			System.out.println("오픈예정 캠페인 총레코드수 구하기 에러...."+e.getMessage());
		}finally {
			closeDB();
		}

	...
	<script>
		...
		<div class="campaign-qna-wrapper w-full"> 
			<div class="table table-fixed w-full text-center font-bold border-b-2 border-gray">
				...
				<div id="offPos" class=" table-cell w-64 p-4">답변여부</div>
			...
			<ul id="camPos" class="campaign-qna-list w-full">
				...
				<li>
					<div class="qna-container w-full text-center border-b border-gray">
						<form id="eidtInfo" method="get" action="<%=adminPath%>/admin/admin_servicecenter.do" class="table table-fixed w-full">

...
<body>
	<div class="w-full max-w-screen-xl my-0 mx-auto flex justify-center items-center h-screen">
		<div class="w-full max-w-sm">
			<div class="text-4xl text-center">관리자 로그인</div> 
			<div class="w-full">					
				<form id="adminForm" method="post" action="<%=adminPath %>/admin/admin_LoginOk.do" class="bg-white rounded px-8 pt-6 pb-8 mb-4">
					...
					<button class="text-white font-bold py-2 px-4 rounded bg-brand w-full my-4 h-12">로그인</button>
				</form>
			</div>
		</div> 
	</div>

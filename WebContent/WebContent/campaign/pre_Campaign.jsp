	...
	<div id="explain" class="w-full max-w-screen-xl my-2 mx-auto border-solid border-gray border-b  my-1 text-4xl py-4">일정보기</div>
		...
		<div id="total" class="w-full max-w-screen-xl my-0 mx-auto flex flex-wrap mb-12">
				<div class=" w-1/3 px-4 mb-12"><a href="#">
					<img src="../img/img_List/medical2.jpg" class="rounded-md"/>
				...
				<div class="w-1/3 px-4"><a href="#">
					...
					<div class="font-bold text-xl" style="color:rgb(255,102,102)">5월 중순 오픈예정</div>
				</a></div>
				<div class="w-1/3 px-4"><a href="#">
					<img src="../img/img_List/culture7.jpg" class="rounded-md"/>
					<div class="text-2xl my-2 hover:text-danger">우리 문화재 발굴</div>
					<div class="my-1 font-thin">우리 문화재</div>
					<div class="font-bold text-xl" style="color:rgb(255,102,102)">6월 초 오픈예정</div>	
				</a></div>
				<div class="w-1/3 px-4"><a href="#">
					...
					<div class="font-bold text-xl" style="color:rgb(255,102,102)">6월 말 오픈예정</div>
				</a></div>
				<div class="w-1/3 px-4"><a href="#">
					...
					<div class="font-bold text-xl" style="color:rgb(255,102,102)">8월 말 오픈예정</div>
				</a></div>
			</div>

...
<body>
			...
			<div class="w-full max-w-screen-xl my-24 mx-auto flex flex-wrap">
				...
				<form method="post" action="<%=projectPath%>/find_id.do" onsubmit="return findUser_Id()">
					<div class="mr-2" style="width:630px"><!----------------------------- 아이디 찾기 -------------------------------------->
						...
						<div class="border border-gray">
							...
							<div class="flex ml-40 hidden" id="emailMsg">
								...
								<c:if test="${vo.user_id==null || vo.user_id==''}"><span class="text-danger text-lg">조회된 아이디가 없습니다. 다시 확인하고 죄회 부탁드립니다.</span></c:if>
								<c:if test="${vo.user_id!=null && vo.user_id!=''}"><span class="text-danger text-lg">조회하신 아이디는 ${vo.user_id}입니다.</span></c:if>

...
<div id="explain"  class="w-full max-w-screen-xl my-2 mx-auto border-solid border-gray border-b  my-1 text-4xl py-4">위시리스트</div>
	 ...
	 <input type="checkbox" style="width:20px;height:20px" class="absolute">
		  <a href="<%=projectPath%>/campaign/detail_Campaign.do"><img  class="w-full " src="<%=projectPath %>/img/img_List/culture.jpg"></a>
			
		  <div style="height:100px; "class="px-6 py-4 ">
		    <div class="font-medium text-xl mb-2">  <a href="<%=projectPath %>/campaign/campaign_detail.do">훼손된 문화재 복원을 위한 후원 펀딩 </a></div>
		  </div>
		  <div class="px-6 py-4">
		...
		<a href="<%=projectPath %>/campaign/detail_Campaign.jsp"><img  class="w-full " src="/project_Ma/img/img_List/medical2.jpg"></a>
		  <div style="height:100px; "class="px-6 py-4 ">
		    <div class="font-medium text-xl mb-2"> <a href="<%=projectPath %>/campaign/detail_Campaign.do">의료지원을 받지 못하는 소외계층을 위한 후원</a></div>
		  </div>
		  <div class="px-6 py-4">
			<div class="relative w-full h-2 rounded-md bg-info-light">
                      <div class="absolute w-1/5 h-full border-solid border-gray border bg-danger rounded-md">
		...
		<!-- 네번째 이미지 -->
		<div style="height :335px ; width:275px" id ="dokdo" class=" max-w-xs rounded overflow-hidden shadow-lg xs:flex ">
		  <a href="<%=projectPath %>/campaign/detail_Campaign.do"><img  class="w-full " src="/project_Ma/img/img_List/tree5.jpg"></a>
		  <div style="height:100px; "class="px-6 py-4 ">
		    <div class="font-medium text-xl mb-2"> <a href="<%=projectPath %>/campaign/detail_Campaign.do">자연을 살리기위한 나무심기 후원 </a></div>
		  </div>
		  <div class="px-6 py-4">
			<div class="relative w-full h-2 rounded-md bg-info-light">
                      <div class="absolute w-1/5 h-full border-solid border-gray border bg-danger rounded-md">
		...
		<!-- 다섯째 이미지 -->
		<div style="height :335px ; width:275px" id ="dokdo" class=" max-w-xs rounded overflow-hidden shadow-lg xs:flex ">
		 <a href="<%=projectPath %>/campaign/detail_Campaign.do"><img  class="w-full " src="/project_Ma/img/img_List/women_in_war.jpg"></a>
		  <div style="height:100px; "class="px-6 py-4 ">
		    <div class="font-medium text-xl mb-2"> <a href="<%=projectPath %>/campaign/detail_Campaign.do">역사를 잊지말자!!</a></div>
		  </div>
		  <div class="px-6 py-4">
			<div class="relative w-full h-2 rounded-md bg-info-light">
                      <div class="absolute w-1/5 h-full border-solid border-gray border bg-danger rounded-md">
		...
		<!-- 여섯번째 이미지 -->
		<div style="height :335px ; width:275px" id ="dokdo" class=" max-w-xs rounded overflow-hidden shadow-lg xs:flex ">
		 <a href="<%=projectPath %>/campaign/detail_Campaign.do"><img  class="w-full " src="/project_Ma/img/img_List/boyukwon2.jpg"></a>
		  <div style="height:100px; "class="px-6 py-4 ">
		    <div class="font-medium text-xl mb-2">  <a href="<%=projectPath %>/campaign/campaign_detail.do">저소득층 계층을 위한 후원</a></div>
		  </div>
		  <div class="px-6 py-4">
			<div class="relative w-full h-2 rounded-md bg-info-light">
		...
		<!-- 일곱번째 이미지 -->
		<div style="height :335px ; width:275px" id ="dokdo" class=" max-w-xs rounded overflow-hidden shadow-lg xs:flex ">
		<a href="<%=projectPath %>/campaign/detail_Campaign.do"><img  class="w-full " src="<%=projectPath %>/img/img_List/africa.jpg"></a>
		  <div style="height:100px; "class="px-6 py-4 ">
		    <div class="font-medium text-xl mb-2">  <a href="<%=projectPath %>/campaign/detail_Campaign.do">기아로 허덕이는 아프리카 주민들을 위한 후원</a></div>
		  </div>
		  <div class="px-6 py-4">
			<div class="relative w-full h-2 rounded-md bg-info-light">
             <div class="absolute w-1/5 h-full border-solid border-gray border bg-danger rounded-md"></div>
		...
		<div style="height :335px ; width:275px" id ="dokdo" class=" max-w-xs rounded overflow-hidden shadow-lg xs:flex ">
		  <a href="<%=projectPath %>/campaign/detail_Campaign.do"><img  class="w-full " src="<%=projectPath %>/img/img_List/culture.jpg"></a>
		  <div style="height:100px; "class="px-6 py-4 ">
		    <div class="font-medium text-xl mb-2">  <a href="<%=projectPath %>/campaign/detail_Campaign.do">문화재 복원 후원</a></div>
		  </div>
		  <div class="px-6 py-4">
			<div class="relative w-full h-2 rounded-md bg-info-light">
                <div class="absolute w-1/5 h-full border-solid border-gray border bg-danger rounded-md">
